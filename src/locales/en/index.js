export default {
	message: {
		...
		home: {
			...
			value: 'Location of the museum floors',
		},
		quationsX: [],
	},
	'О нас': 'About',
	...
	'Muzeyda ekskursiyalarni qanday turlari mavjud?':
		'What types of extractions are there in the museum?',
	'Muzeyda turli toifadagi davr uchun eksponatlar mavjud':
		'The museum has exhibits for the period of different categories',

	'Muzeyda O`zbekistonning qadimgi allomalari bo`yicha ma`lumot mavjudmi?':
		'Is there any information on ancient scientists of Uzbekistan in the museum?',
	'Muzeyda 1- va 2- rezenans davrida ujod qilgan ajdodlarimiz xaqida aloxida bo`limlar mavjud':
		'The museum has sections in alokhida about our ancestors who died during the 1st and 2nd resonance',

	'Bu muzeyda qadimiy shaxarlar va qadimiy yozuv madaniyatiga oid tarixiy manbalar mavjudmi?':
		'Is there any historical reference to ancient cities and ancient writing culture in this museum?',
	'Bu Muzey O`zbekistonning qadimiy davridan bugungi kungacha bo`lgan tarixi aks ettirilgan Xorazm, Baqtriya, So`g`d, Farg`ona kabi qadimiy davlatlar va ko`plab shaxarlarning tarixi xaqida Ma`lumot olish mumkin':
		'It is possible to get information about the history of ancient countries and many cities such as Khorezm, Bactria, Sogd, Fergana, which reflect the history of Uzbekistan from the ancient times to the present day',

	'Muzeyda bolalar uchun maxsus ko`rgazmalar va malaka darslari tashkil etilganmi?':
		'Has the museum organized special visualizations and qualification classes for children?',
	'2011-yilda respublikamizda ulk bora O`zbekiston Tarixi Davlat Muzeyi qoshidagi "Mo`jizalar olamida" bolalar muzeyi tashkil etilgan.Bu yerda xar seshanba va juma kunlari bolalar uchun kulolchilik, kashtachilik va tasviriy san`at yo`nalishlarida maxorat darslari bo`lib o`tadi':
		'In 2011, a children`s Museum "in the world of Miracles" was established at the ulk anem State Museum of the history of Uzbekistan in our republic . Here on Tuesdays and Fridays in the choir there are master classes for children in the fields of ceramics, embroidery and Fine Arts',
};
